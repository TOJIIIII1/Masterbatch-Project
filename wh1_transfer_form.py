...
class Wh1TransferForm:
    ...
    def display(self, parent_frame):
        ...
        label = ttk.Label(parent_frame, text="Transfer Form", style="Custom.TLabel")
    ...
    def add_row_wh1_transfer_form(self, table):
        try:
            ...
            if not reference_no or not date or not material_code or not quantity or not area_to:
            ...
            # Insert a new row into PostgreSQL (wh1_transfer_form table)
            query = """INSERT INTO wh1_transfer_form (reference_no, date, material_code, quantity, area_to) 
                       VALUES (%s, %s, %s, %s, %s)"""
            values = (reference_no, date, material_code_id, quantity, area_to)
    ...
    def delete_row_wh1_transfer_form(self, table):
        try:
            ...
            query = "DELETE FROM wh1_transfer_form WHERE reference_no = %s::TEXT"
