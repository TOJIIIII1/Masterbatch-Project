...
class Spreadsheet4:
    ...
    def process_fetched_data(self, rows):
        ...
        try:
            ...
            # After processing, update or insert the data into the `wh4_spreadsheet` table
    ...
    def update_or_insert_data_into_spreadsheet(self):
        """Update or insert data into the wh4_spreadsheet table."""
        try:
            for record in self.data:
                ...
                # Check if the record exists in the `wh4_spreadsheet` table
                check_query = """
                SELECT 1 FROM wh4_spreadsheet 
                ...
                if existing_record:  # Record exists, perform an update
                    ...
                    insert_query = """
                    INSERT INTO wh4_spreadsheet (material_code, no_of_bags, qty_per_packing, whse1_excess, total, status)
                    VALUES (%s, %s, %s, %s, %s, %s);
                    """
                    values = (
    ...
    def display(self, parent_frame):
        ...
        tk.Label(frame, text="Warehouse 4: SOH SUMMARY", font=("Arial", 25, "bold")).grid(
