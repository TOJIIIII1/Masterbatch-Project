...
class Wh4ReceivingReport:
    ...
    def add_row_wh4_receiving_report(self, table):
        try:
            ...
            area_location = self.wh4_receiving_report_entries[4].get()
    ...
    def update_row_wh4_receiving_report(self, table):
        try:
            ...
            self.cursor.execute("SELECT id FROM wh4_receiving_report WHERE reference_no = %s", (reference_no,))
            ...
            area_location = self.wh4_receiving_report_entries[4].get().strip()
