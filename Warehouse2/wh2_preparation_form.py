...
class Wh2PreparationForm:
        ...
        try:
            ...
            query = """
                SELECT wh2_preparation_form.reference_no, 
                       ...
                       wh2_preparation_form.quantity_return,  
                       wh2_preparation_form.area_location,
    ...
    def display(self, parent_frame):
        ...
        for i, label_text in enumerate(column_names_wh2_preparation_form):
            ...
            if label_text == "Date Received":
                ...
                wh2_preparation_form_entries.append(status_combobox)
    ...
    def add_row_wh2_preparation_form(self, table):
        try:
            ...
            status = self.wh2_preparation_form_entries[6].get()
            ...
            query = """INSERT INTO wh2_preparation_form (reference_no, date, material_code, quantity_prepared, quantity_return, area_location, status) 
            ...
            data_wh1_preparation_form = self.fetch_data_from_wh2_preparation_form()
    ...
    def update_row_wh2_preparation_form(self, table):
        try:
            ...
            status = self.wh2_preparation_form_entries[6].get().strip()
