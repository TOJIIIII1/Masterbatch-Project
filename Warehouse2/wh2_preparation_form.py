...
class Wh2PreparationForm:
    ...
    def add_row_wh2_preparation_form(self, table):
        try:
            ...
            messagebox.showinfo("Success", "Row added successfully to Warehouse 2: Preparation Form.")
            ...
            messagebox.showerror("Error", f"Error while adding row to Warehouse 2: Preparation Form: {e}")
