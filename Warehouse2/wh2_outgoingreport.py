...
class Wh2OutgoingReport:
    ...
    def add_row_wh2_outgoing_report(self, table):
        try:
            ...
            # Retrieve values from entry fields for Table 2
            ...
            # Get material_code_id from the wh2_material_codes table
            ...
            # Check the available total quantity in wh2_material_code_totals
            ...
            query = """INSERT INTO wh2_outgoing_report (reference_no, date_outgoing, material_code, quantity, area_location) 
                       VALUES (%s, %s, %s, %s, %s)"""
            values = (reference_no, date_outgoing, material_code_id, quantity, "Warehouse 2")
