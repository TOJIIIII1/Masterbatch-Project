...
class Wh2TransferForm:
    ...
    def display(self, parent_frame):
        ...
        for i, label_text in enumerate(column_names_wh2_transfer_form):
            ...
            if label_text == "Date Received":
                ...
                wh2_transfer_form_entries.append(area_combobox)
    ...
    def add_row_wh2_transfer_form(self, table):
        try:
            ...
            get_material_codes_with_status = """
                SELECT material_code_name FROM wh2_material_code_totals WHERE status = %s
            """
            ...
            get_total_quantity = """
                SELECT total_quantity FROM wh2_material_code_totals WHERE material_code_name = %s AND status = %s
            """
            ...
            # Step 5: Insert into the wh2_transfer_form
            query = """
            ...
            if area_to == "1":
                ...
                self.cursor.execute(insert_wh2_query,
                                    (reference_no, date, material_code_id, quantity, "From Warehouse 2", status))
                self.conn.commit()
            ...
            # **Refresh the Treeview for wh2_transfer_form**
            data_wh2_transfer_form = self.fetch_data_from_wh2_transfer_form()
    ...
    def delete_row_wh2_transfer_form(self, table):
        ...
        try:
            ...
            # Fetch the unique 'id' from wh2_receiving_report
